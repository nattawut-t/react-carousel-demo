...
class Carousel extends Component {
  componentDidMount() {
    ...
    const $firstAnimatingElems = $myCarousel.find('.item:first').find("[data-animation ^= 'animated']")

    // console.log('firstAnimatingElems: ', $firstAnimatingElems)

    $firstAnimatingElems.carousel()
  }
